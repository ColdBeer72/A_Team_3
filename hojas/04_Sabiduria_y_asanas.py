...
with st.expander("**Los orígenes del Ashtanga**"):
    ...
    st.image("streamlit_sources/page4/wikimagenes/krishnamacharya.jpg", caption="Krishnamacharya es el maestro de K. Pattabhi Jois, principal impulsor del Yoga contemporáneo")
    ...
    st.image("streamlit_sources/page4/wikimagenes/pattabhi.jpg", caption="Pattabhi Jois fue el creador del Ashtanga yoga moderno y principal impulsor del yoga en occidente a través de sus alumnos.")

with open("streamlit_sources/page4/sutras.md", "r", encoding="utf-8") as sutras_md:
...
with st.expander("**Los Sutras de Patanjali**"):
    ...
    st.image("streamlit_sources/page4/wikimagenes/sutras_papiro.png", caption="Los sutras son textos del siglo III a. C.")
...
with st.expander("**Surya Namaskar A** ***(Saludo al Sol A)***"):
    ...
    st.image("streamlit_sources/page4/wikimagenes/Surya Namaskar.png", caption="El saludo al sol (Surya Namaskar en sanscrito) Es una práctica fundamental en muchas tradiciones de yoga y se utiliza tanto como calentamiento al inicio de una clase como una práctica completa en sí misma.", width=None)